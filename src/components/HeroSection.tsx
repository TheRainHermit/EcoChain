...
import EcoGameSection from "./EcoGameSection";


export const HeroSection: React.FC = () => {

// Función para hacer scroll suave a la sección de "Cómo funciona"
      ...
      <section className="bg-gradient-to-br from-gray-900 via-green-900 to-emerald-900 text-white py-16">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-4xl md:text-6xl py-4 font-extrabold mb-6 bg-gradient-to-r from-green-300 via-emerald-400 to-teal-400 bg-clip-text text-transparent drop-shadow-lg animate-fade-in">
            EcoChain:{" "}
            <span className="text-emerald-400">Recicla, Gana, Impacta</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
            <button
              className="flex items-center justify-center space-x-2 bg-white/90 text-green-700 px-8 py-3 rounded-full font-semibold shadow hover:bg-green-100 hover:scale-105 transition-transform border border-green-200"
