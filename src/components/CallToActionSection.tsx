...
const CallToActionSection: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-r from-emerald-600 to-green-900 text-white text-center">
      ...
      <p className="mb-8 text-lg">Comienza a ganar EcoCoins y NFTs por ayudar al planeta.</p>
      <img src="./src/assets/ecochainlogosinfondo.png" alt="EcoChain Logo" className="mx-auto mt-8" />
    </section>
  );
};
